...
const Domain = () => {
  ...
  const domains = [
    ...
    {
      src: "/assets/research-innovation.png",
      alt: "Research & Innovation Domain",
      w: 500.5,
      h: 169,
      name: "Research & Innovation",
      description:
        "Exploring emerging technologies, working on research papers, and driving innovation through impactful projects and ideas.",
  ...
  return (
    <section className="min-h-screen bg-black">
      ...
      <div className="pt-8 px-8 sm:pt-12 sm:px-12 lg:pt-16 lg:px-16 xl:px-20 mb-4">
        ...
        {/* Updated colorful underline like reference */}
        <div className="h-[4px] w-22 bg-gradient-to-r from-[#4285F4] via-[#EA4335] to-[#FBBC04] rounded-full mt-2"></div>
      </div>
            ...
            >
              ...
              >
                ...
                >
                  ...
                  <p className="text-lg sm:text-xl md:text-base lg:text-xl text-gray-700 leading-relaxed">
                    {domain.description}
                  </p>
                </div>
              </div>
